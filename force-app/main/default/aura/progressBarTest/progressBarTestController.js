	...
	myAction : function(component, event, helper) {
        helper.doProgressBarRender(component, event, helper);
            ...
            moveNextClick:function(component,event,helper){
                ...
                var steps = [{Name:"step1",val:"1",displaycmp:'test 1'},{Name:"step2",val:"2",displaycmp:'sho wpage'},{Name:"step3",val:"3",displaycmp:'Accoutn test table1'},{Name:"step4",val:"4",displaycmp:'2 components test'}];//component.get('v.progresSteps');
